<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDriver.aspx.cs" Inherits="CarManager_AddDriver" %>
...
<body>
    ...
    <table style="height: 263px; width: 398px;">
     <tr align="center">
      <td>
          &nbsp;&nbsp;&nbsp;
          姓 名：<asp:TextBox ID="txtName" class="inputs" runat="server" Width="122px"></asp:TextBox>
     ...
     <tr align="center">
      <td>
          &nbsp;&nbsp;&nbsp;
          年 龄：<asp:TextBox ID="txtAge" class="inputs" runat="server" Width="122px"></asp:TextBox>
     ...
     <tr>
      <td colspan="2" align="center">
          地 址：<asp:TextBox ID="txtAddRess" class="inputs" runat="server" Width="122px"></asp:TextBox>
     ...
     <tr>
      <td colspan="2" align="center">
          电 话：<asp:TextBox ID="txtPhone" class="inputs" runat="server" Width="122px"></asp:TextBox>
