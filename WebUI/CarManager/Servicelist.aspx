<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Servicelist.aspx.cs" Inherits="CarManager_Servicelist" %>
            ...
            <tr>
                <td>
                     ...
                     <asp:GridView ID="gvService" runat="server" AutoGenerateColumns="False" 
                         DataKeyNames="S_Id" Height="140px" Width="745px">
                         <Columns>
...
&nbsp;<input ID="Checkbox11" type="checkbox" onclick="selAll(this)"  / >全选
                             ...
                             <asp:TemplateField HeaderText="查询">
                                 <ItemTemplate>
                                     <asp:LinkButton ID="lbtnSel" runat="server" CommandArgument='<%# Eval("S_Id") %>' 
                                         CommandName='Sel' oncommand="lbtnSel_Command">查 询</asp:LinkButton>
                                 </ItemTemplate>
                             </asp:TemplateField>
                             <asp:TemplateField HeaderText="修改">
                                 <ItemTemplate>
                                     <asp:LinkButton ID="lbtnUp" runat="server" CommandArgument='<%# Eval("S_Id") %>' 
