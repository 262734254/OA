<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enter.aspx.cs" Inherits="CarManager_Enter" %>
    ...
    <table class="style1">
        ...
        <table style="height: 435px; width: 573px;">
                        ...
                        Type="Double" Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator>
                            ...
                            <tr>
                                <td>
                                    预计返回日期: <input type="text" ID="txtReturnDate" runat="server" class="inputs" 
                    ...
                    ></asp:TextBox>
                                ...
                                <td>
                                    回车里程：<asp:TextBox ID="txtHuiCheLiCheng" class="inputs" runat="server"></asp:TextBox>
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="left" colspan="3">
                                    &nbsp;&nbsp;车辆类型：                   &nbsp;&nbsp;车辆类型：<asp:RadioButton ID="rdo1" class="inputs" runat="server" 
                        ...
                        GroupName="a" />
                            ...
                            <tr>
                                <td class="style2" colspan="3">
                                    备注：备注：<asp:TextBox ID="txtReMark" runat="server" Height="100px" 
