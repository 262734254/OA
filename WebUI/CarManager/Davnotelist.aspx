        ...
        <table>
            ...
            <tr>
                <td style="height:70px">
                    ...
                    出车部门：<asp:DropDownList ID="ddlDept" class="inputs" runat="server" 
                        Height="18px" Width="89px" DataSourceID="odsDept" 
                    ...
                    &nbsp;<asp:Button ID="btnSelect" class="BigButton" runat="server" 
                        Text="查   询" onclick="btnSelect_Click" />
                    
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href ="AddDavnote.aspx">添加记录</a><asp:ObjectDataSource ID="odsDept" 
            ...
            <tr>
                <td>
                         ...
                         <asp:GridView ID="gvDavnote" runat="server" AutoGenerateColumns="False" 
                             Height="132px" Width="585px" onrowdatabound="gvDavnote_RowDataBound" 
                                ...
                                <ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="删除">
                                  ...
                                  <asp:TemplateField HeaderText="回车">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkhuiche" runat="server" 
