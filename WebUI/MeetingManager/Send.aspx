<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send.aspx.cs" Inherits="UserWork_MailSend" %>
                ...
                <td class="td_page">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td height="30">
                                <span class="style4">
                                    <asp:DropDownList ID="ddlDepartment"  style="width:170px " CssClass="box" onchange="makeValue()" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="dept" name="selectBasRight" onchange="selectPerson()" size="16" 
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="txtName" class="input" name="txtName" style="width:94%" 
                                    type="text" /></td>
                        </tr>
                    </table>
                </td>
