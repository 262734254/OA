            ...
            <tr>
                ...
                <td align="left" style="height: 2px">
                    <asp:RadioButton ID="RadioIs" runat="server" AutoPostBack="True" GroupName="radioR"
                        OnCheckedChanged="RadioIs_CheckedChanged" Text="是" Enabled="False" />
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:RadioButton ID="RadioNo" runat="server" AutoPostBack="True" Checked="True" GroupName="radioR"
                        OnCheckedChanged="RadioNo_CheckedChanged" Text="否" Enabled="False" />
                    <asp:Panel ID="Panel1" runat="server" Height="20px" Visible="False" Width="200px">
                        <asp:RadioButton ID="RadioButton1" runat="server" Checked="True" GroupName="radio"
                            Text="按日重复" Enabled="False" />
                        &nbsp;
                        <asp:RadioButton ID="RadioButton2" runat="server" GroupName="radio" Text="按周重复" Enabled="False" /></asp:Panel>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 93px; height: 2px">
