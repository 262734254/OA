            ...
            <tr>
                <td align="center" valign="top">
                    <table style="height: 289px; width: 525px;">
                        <tr align="left">
                            <td>
                                借用单号：<asp:TextBox ID="txtBorrowNo" class="inputs" runat="server" 
                                    Width="120px" AutoPostBack="True" ontextchanged="txtBorrowNo_TextChanged"></asp:TextBox>
                            ...
                            <td>
                                资源名称：<asp:DropDownList ID="ddlName" runat="server" DataTextField="Number" 
                                    DataValueField="Number" Width="120px" AppendDataBoundItems="True">
                        ...
                        <tr align="left">
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvCallBackNum" runat="server" ControlToValidate="txtCallBackNum"
                            ...
                            <td>
                                回收时间：<input type="text" onclick="showcalendar(event, this);" id="txtStartTime" runat="server"
                                    ...
                                    border-bottom: #99ccff 1px solid; width: 120px;" /><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*"
                    ...
                    <asp:ObjectDataSource ID="odsResourceName" runat="server" SelectMethod="GetAllApplicationResource"
                        TypeName="BLL.Resource.ApplicationResourseManager">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="1" Name="type" Type="Int32" />
                            <asp:ControlParameter ControlID="txtBorrowNo" DefaultValue="" Name="id" PropertyName="Text"
                                Type="Int32" />
                        </SelectParameters>
