                        ...
                        border-top: #99ccff 1px solid; border-left: #99ccff 1px solid; border-bottom: #99ccff 1px solid" 
                            ...
                            <tr align="left">
                                ...
                                <td class="style4">
                                     ...
                                     <asp:ObjectDataSource ID="objs" runat="server" SelectMethod="GetAllDepartment" 
                                         TypeName="BLL.Target.TaskManager"></asp:ObjectDataSource>
                                </td>
                                <td align="left">
                                    负&nbsp;责&nbsp人：
                                </td>
                                <td>
                                     <asp:DropDownList ID="ddlLeaderMan" runat="server" CssClass="BigSelect" 
                                         DataSourceID="objess12" DataTextField="Name" DataValueField="UID">
                                         <asp:ListItem>部门主管</asp:ListItem>
                                     </asp:DropDownList>
                                            <asp:ObjectDataSource ID="objess12" runat="server" 
                                         SelectMethod="GetAllUsersByDepartmentId" TypeName="BLL.Target.TaskManager">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="ddlLeader" Name="id" 
                            ...
                            <tr align="left">
                                ...
                                <td class="style4">
                                     ...
                                     <asp:ObjectDataSource ID="objssss" runat="server" 
                                         SelectMethod="GetAllTaskLeaders" TypeName="BLL.Target.TaskManager">
                                     </asp:ObjectDataSource>
                                </td>
                                <td align="left">
                                    加权系数：
                            ...
                            <tr align="left">
                                ...
                                <td colspan="3">
                                     ...
                                     <asp:ObjectDataSource ID="bjss234" runat="server" 
                                         SelectMethod="GetAllUsersByDepartmentId" TypeName="BLL.Target.TaskManager">
                                         <SelectParameters>
                                             <asp:ControlParameter ControlID="ddlPutDepart" Name="id" 
                                                 PropertyName="SelectedValue" Type="Int32" />
                                         </SelectParameters>
                                     </asp:ObjectDataSource>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" align="left">
                                    &nbsp;<asp:FileUpload ID="fileUpload" onchange="checkInput(this)"   runat="server"   />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目标金额数：<asp:TextBox 
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <asp:Button ID="btnSave" runat="server" CssClass="BigButton" 
                                        onclick="btnSave_Click"   ToolTip="添加"  Text="保   存" />
&nbsp;&nbsp;<asp:Button ID="btnSend" runat="server" CssClass="BigButton" onclick="btnSend_Click" ToolTip="添加" Text="发  送" />
&nbsp;
