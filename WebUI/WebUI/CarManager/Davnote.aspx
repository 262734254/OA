<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeFile="Davnote.aspx.cs" Inherits="Davnote" %>
    ...
    <table class="style1">
        ...
        <table style="height: 435px; width: 573px;">
                        ...
                        runat="server" ErrorMessage="*"
                            ...
                            <tr>
                                <td>
                                    出车日期：<asp:TextBox ID="txtOutDate" runat="server" CssClass="inputs" onclick="showcalendar(event, this);" DataFormatString="{0:yyyy-MM-dd}"></asp:TextBox>
                        ...
                        Type="Double" Operator="GreaterThan" ValueToCompare="0"></asp:CompareValidator>
                            ...
                            <tr>
                                <td>
                                    返回日期：<asp:TextBox ID="txtReturnDate" runat="server" CssClass="inputs" onclick="showcalendar(event, this);"></asp:TextBox>
                    ...
                    车辆类型：<asp:RadioButton ID="rdo1" class="inputs" runat="server" 
                        ...
                        PostBackUrl="~/CarManager/Davnotelist.aspx" onclick="btnback_Click" Height="20px" />
                                    &nbsp;&nbsp;&nbsp;
                                    </td>
                            </tr>
                        </table>
