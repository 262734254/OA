                ...
                <td align="center">
                    <table width="80%" cellpadding="2" cellspacing="1" border="0" class="px12" style="font: menu">
                        ...
                        <tr>
                            ...
                            <td align="left" style="height: 2px">
                                <textarea name="txtVisitor" id="txtVisitor" class="TxCss" style="border: 1px solid #99ccff; height: 79px; width: 380px;
                                    " runat="server" readonly="readOnly" cols="20" 
                                    onclick="return txDes0_onclick()">陈单玲、李程、周伟、王康、黄璜、朱元当</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" class="style3">
                            ...
                            <td align="left" style="height: 2px">
                                <textarea name="txDes1" id="txtMissingPeople" class="TxCss" style="border: 1px solid #99ccff; height: 81px; width: 380px;
                                    " runat="server" readonly="readOnly" cols="20">陈单玲</textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" class="style6">
                                <textarea name="txDes" id="txtMeetingContent" class="TxCss" style="border: 1px solid #99ccff; height: 85px; width: 380px;
                                    " runat="server" readonly="readOnly">通知。本周六下午召开小组会议，请大家准备好！</textarea>
                            </td>
                        </tr>
                        <tr>
