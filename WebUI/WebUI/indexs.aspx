...
if(window.confirm('确定退出吗？'))
 {
  ...
  window.open("Login.aspx","退出系统","height=0,width=0,top=0,left=0");   //  关闭当前窗口   
  parent.parent.close(); 
 }
}
...
CLASS_MSN_MESSAGE.prototype.show = function(){  
    ...
    var str = "<DIV style='BORDER-RIGHT: #455690 1px solid; BORDER-TOP: #a6b4cf 1px solid; Z-INDEX: 99999; LEFT: 0px; BORDER-LEFT: #a6b4cf 1px solid; WIDTH: " + w + "px; BORDER-BOTTOM: #455690 1px solid; POSITION: absolute; TOP: 0px; HEIGHT: " + h + "px; BACKGROUND-COLOR: #c9d3f3'>"  
        ...
        str += "<DIV style='BORDER-RIGHT: #b9c9ef 1px solid; PADDING-RIGHT: 8px; BORDER-TOP: #728eb8 1px solid; PADDING-LEFT: 8px; FONT-SIZE: 12px; PADDING-BOTTOM: 8px; BORDER-LEFT: #728eb8 1px solid; WIDTH: 100%; COLOR: #1f336b; PADDING-TOP: 8px; BORDER-BOTTOM: #b9c9ef 1px solid; HEIGHT: 100%'>消息标题<BR><BR>"  
        str += "<DIV style='WORD-BREAK: break-all' align=left><A href=\"#\" hidefocus=false id='btCommand'><FONT color=#ff0000>" +this.title  + "</FONT></A>：<A href=\"#\"  hidefocus=false id='ommand'><FONT color=#ff0000>"+ this.message +"</FONT></A></DIV>"  
        str += "</DIV>"  
        str += "</TD>"  
        str += "</TR>"  
        str += "</TABLE>"  
    ...
    btCommand.onclick = function(){  
        addTestTab('Calendar/SelectCalender.aspx','日程消息');
        //me.oncommand();  
    }    
...
function GetCountAndTitme()
{

  title=indexs.GetTitle().value;
  count=indexs.GetTotal().value;


   var str="您有"+count+"封消息";
   var srt33=title;
  
        var MSG2 = new CLASS_MSN_MESSAGE("aa",200,120,"短消息提示：",str,srt33);  
...
<body style="font-size: 12px;" onload="timeview();GetCountAndTitme();" >
                    ...
                    <Toolbars>
                        <ext:Toolbar ID="Toolbar1" Position="Bottom" runat="server">
                            <Items>
                                ...
                                <ext:Image ID="UpdatePwd" runat="server" ImageUrl="images/66.gif">
                                </ext:Image>
                                <ext:HyperLink ID="HLUpPwd" OnClientClick="addTestTab('UpdatePwd.aspx','修改密码');"
                                    runat="server" Text="修改密码" CssClass="td">
                                </ext:HyperLink>
                            </Items>
                        </ext:Toolbar>
                    </Toolbars>
                            ...
                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="center" align="middle" width="48">
                                                        <img style="cursor: hand" onclick="javascript:alert('欢迎使用！');" height="50" alt="显示帮助/隐藏帮助"
                                                            src="images/index_06.gif" width="48" border="0" onclick="GoTable()"></td>
                                                    <td valign="center" align="middle" width="58">
                                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="images/index_07.gif"    OnClientClick="iflogout()" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="small" style="color:White;" align="right">
                                        现在时刻：<b><span id="time_area" style="color:White;"> <div  id="total" style="width: 300px; height: 300px;" visible="false"></div>
                                         <div  id="title" style="width: 300px; height: 300px;" visible="false"></div></span></b>&nbsp;&nbsp;
                                        </td>
                                </tr>
                            </tbody>
                        </table>
						  ...
						  <td align="center" class="td01">
							  <table width="95%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									  ...
									  <td width="35" align="right">
										  <a href="PedingMatter/Matter.aspx" target="mainFrame"><img 	src="images/main_53.gif" 
                            ...
                            width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
	                              ...
	                              <asp:LinkButton ID="lbPending" PostBackUrl="~/MeetingManager/ApplictionMeetingList.aspx" runat="server"><%# Eval("ResponseMan")%> 提交<%# Eval("ApplicationType")%>待审批办理时间 :<%# Eval("Timer")%></asp:LinkButton>										  									
						  ...
						  <td align="center" class="td01">
							  <table width="95%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									  ...
									  <td width="35" align="right">
										  <a href="LeaveMessage/ShowMessage.aspx" mainFrame><img
												src="images/main_53.gif" width="35" height="9" border="0"/></a>
									  </td>
								  </tr>
								  <tr>
									  <td height="1" class="td05">
									  ...
									  <td>
										  <table width="100%" border="0" cellspacing="0" cellpadding="0">
											  <tr>
												  ...
												  <td valign="top" class="td08">
													  <a href="LeaveMessage/ShowMessage.aspx"target="_blank">刘岳
											  ...
											  <tr>
												  ...
												  <td valign="top" class="td08">
													  <a href="LeaveMessage/ShowMessage.aspx"target="_blank">张三
					...
					<tr>
						...
						<td class="td06">
							<table width="100%" border="0" cellspacing="4" cellpadding="0">
								<tr>
									<td><asp:Label ID="lblLoginName" runat="server" Text="Label"></asp:Label>
										，您好！
										<br>
										欢迎登录上海民政局OA系统
										<br>
										...
										上次登录时间为：
										<br>
										<span class="F01"><asp:Label ID="lblTime" runat="server" ></asp:Label></span>
										<br>
										这是您第<asp:Label ID="lblCount" runat="server" Text="Label"></asp:Label>次登录本系统
									</td>
								</tr>
							</table>
						</td>
...
//  End -->
				...
				<table width="163" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<a href="javascript:addTestTab('AddressManager/Userlist.aspx','个人通讯录')" target="main">个人通讯录</a>
							<br>
				...
				<table width="163" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<a href="javascript:addTestTab('PowerManager/User/UpdateUser.aspx','个人设置')" target="main">个人设置</a>
							<br>
							<img src="images/main_50.gif" width="43" height="9">
						</td>
					</tr>
