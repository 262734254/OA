            ...
            <tr>
                <td align="center" style="height: 442px">
                    <table cellpadding="2" cellspacing="1" border="0" 
                        ...
                        <tr>
                            ...
                            <td align="left" class="style3">
                                <asp:TextBox ID="txtEndTime" runat="server" 
                                    ...
                                    border-top: #99ccff 1px solid; border-left: #99ccff 1px solid; border-bottom: #99ccff 1px solid" onclick="showcalendar(event, this);"></asp:TextBox>
                                &nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="btnOK" runat="server" CssClass="TableLine1" Text="提   交" 
                                    Height="26px" Width="54px" onclick="btnOK_Click" />
                            &nbsp;&nbsp;
