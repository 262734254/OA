            ...
            <tr>
                <td align="center">
                    <table style="height: 373px">
                        <tr align="left">
                            <td class="style2">
                                审批类型：<asp:TextBox ID="txtResourceName" class="inputs" runat="server" 
                            ...
                            <td>
                                申请单号：<asp:TextBox ID="txtStockNorm" class="inputs" runat="server" 
                                    Enabled="False"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left" class="style2">
                                审&nbsp; 批 人：<asp:TextBox ID="txtQuantity" class="inputs" runat="server" 
                                    Enabled="False"></asp:TextBox>
