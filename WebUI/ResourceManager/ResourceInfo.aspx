...
<body>
                    ...
                    <table style="height: 422px; width: 537px;">
                        <tr align="left">
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvRIName" runat="server" Display="Dynamic" 
                                    ErrorMessage="请输入名称" ControlToValidate="txtRIName">*</asp:RequiredFieldValidator>
                            </td>
                            <td>
                        ...
                        <tr align="left">
                            <td>
                                ...
                                <asp:CompareValidator ID="CompareValidator2" runat="server" 
                                    ControlToValidate="txtPrice" Display="Dynamic" ErrorMessage="请输入数字" 
                            ...
                            <td>
                                购买时间：<input type="text" onclick="showcalendar(event, this);" id="txtInTime" runat="server"
                                    ...
                                    border-bottom: #99ccff 1px solid; width:120px;" /><asp:RequiredFieldValidator ID="rfvInTime" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtInTime" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr align="left">
                            <td>
                                供 应 商 ：<asp:DropDownList ID="ddlProvider" runat="server" class="inputs" 
                                    Width="120px" DataSourceID="odsProvider" DataTextField="PName" 
                                    DataValueField="PID">
                                </asp:DropDownList>
                            </td>
                            <td>
                                资源类型：<asp:DropDownList ID="ddlResourceType" class="inputs" runat="server"  
                                    Width="120px" DataSourceID="odsResourceType" DataTextField="RTName" 
                                    DataValueField="RTID">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvRISpec" runat="server" 
                                    ControlToValidate="txtRISpec" Display="Dynamic" ErrorMessage="请输入规格">*</asp:RequiredFieldValidator>
                            </td>
                            <td align="left">
                                资 料 室 ：<asp:DropDownList ID="ddlResourceStore" class="inputs" runat="server"  
                                    Width="120px" DataSourceID="odsResourceStore" DataTextField="RSName" 
                                    DataValueField="RSID">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="left" class="style3">
                                ...
                                <asp:RequiredFieldValidator ID="rfvRIRemark" runat="server" 
                                    ControlToValidate="txtRIRemark" Display="Dynamic" ErrorMessage="请输入备注">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
    ...
    <div>
        <asp:ObjectDataSource ID="odsProvider" runat="server" 
            SelectMethod="GetAllProvider" TypeName="BLL.Resource.ProviderInfoManager"></asp:ObjectDataSource>
        ...
        <asp:ObjectDataSource ID="odsResourceStore" runat="server" 
            SelectMethod="GetAllResourceStore" TypeName="BLL.Resource.ResourceStoreManager">
        </asp:ObjectDataSource>
    </div>
    </form>
</body>
