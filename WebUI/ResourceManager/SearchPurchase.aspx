<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchPurchase.aspx.cs" Inherits="PurchaseSearch" %>
            ...
            <tr>
                <td align="center">
                    <table>
                        <tr>
                            <td>
                                资源名称：<asp:TextBox ID="txtDept" class="inputs" runat="server" Width="120px"></asp:TextBox>
                                &nbsp; 资源类型：<asp:DropDownList ID="DropDownList1" class="inputs" runat="server">
                                </asp:DropDownList>
                                &nbsp;&nbsp;资源数量：&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="DropDownList3" class="inputs"
                                    runat="server">
                                </asp:DropDownList>
                                &nbsp;购买时间：<asp:DropDownList ID="DropDownList4" class="inputs" runat="server">
                                </asp:DropDownList>
                                &nbsp;&nbsp;<asp:Button ID="Button2" runat="server" class="BigButton" Text="查  询" />
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" class="style1">
                                    ...
                                    <tr align="center" class="TableContent">
                                        ...
                                        <td>
                                            <a href="ApplyBorrowInfo.aspx">查询</a>
                                        </td>
                                        <td>
