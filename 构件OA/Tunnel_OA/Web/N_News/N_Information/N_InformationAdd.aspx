<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_InformationAdd.aspx.cs" Inherits="N_News_N_Departments_N_KeshiAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr align="left">
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="N_InformationAdd.aspx?type=<%=Request.QueryString["type"] %>" class="a">
    <div style="width:73; height:27px; cursor:pointer;">发布信息</div></a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="N_InformationManage.aspx?type=<%=Request.QueryString["type"] %>" class="a">
