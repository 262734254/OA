<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_GonggaoManage.aspx.cs"
    Inherits="N_News_N_GonggaoManage" %>
  ...
  <tr align="left">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" bordercolorlight="#c8c8c8" bordercolordark="#FFFFFF" 
        ...
        <tr>
            ...
            <td style="border-top:0px;border-right:0px" width="60" align="center" bgcolor="#f6f6f6">
                <strong>操作</strong>
            </td>
        </tr>
            ...
            <ItemTemplate>
                <tr bgcolor="#FFFFFF" height="26">
                    <td style="border-left:0px;" bgcolor="#FFFFFF" align="left" height="26">
                        &nbsp;<a href="N_GonggaoView.aspx?Id=<%#Eval("i_id")%>&TypeId=<%=TypeId %>" title="查看详细"><%#Eval("i_title")%></a>
                    </td>
