<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="N_GonggaoView.aspx.cs" Inherits="Common_ViewNewsAnnouncement" %>
    ...
    <div>
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#c1c1c1"
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        <td style="border-top: 0px; border-right: 0px; border-left: 0px" bgcolor="#f6f6f6"
                    ...
                    <tr>
                        <td height="25" align="center" bgcolor="#e6f7ff" style="border: 0px" colspan="2">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-left: 1px #6f97b1 solid;
            ...
            <tr>
                <td style="border: 0px" colspan="2">
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#c1c1c1"
                        bordercolordark="#FFFFFF" style="border-collapse:collapse;border-bottom: 1px #6f97b1 solid; border-right: 0px #6f97b1 solid;
                        border-left: 0px #6f97b1 solid">
                        <tr height="25">
                            ...
                            <td style="border-top: 0px; border-right: 0px;" width="15%" align="center" bgcolor="#f6f6f6"
                                height="20">
                                <strong>时间</strong>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td height="25" align="center" class="di" colspan="3" style="border: 0px;">
