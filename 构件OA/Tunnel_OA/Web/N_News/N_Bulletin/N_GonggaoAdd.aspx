<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_GonggaoAdd.aspx.cs" Inherits="N_News_N_GonggaoAdd" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-top:1px #6f97b1 solid;border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <tr align="left">
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="N_GonggaoAdd.aspx" class="a">
    <div style="width:73; height:27px; cursor:pointer;">发布公告</div></a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="N_GonggaoManage.aspx" class="a">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
        <td width="50" height="70px" align="center" bgcolor="#f6f6f6">标题：</td>
        <td align="left" bgcolor="#f6f6f6"><asp:TextBox runat="server" ID="tb_Title" TextMode="MultiLine" 
                Width="70%"  
                onkeyup="javascrip:checkWord(200,event,'ctl00_ContentPlaceHolder1_lbl1')" 
                Height="35px" AutoPostBack="False"></asp:TextBox>
                <br />
