<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="N_FilesManageManage.aspx.cs" Inherits="N_News_N_FilesManage_N_FilesManageManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-bottom:0px #6f97b1 solid;border-left:1px #6f97b1 solid;height:30px;border-right:1px #6f97b1 solid">
        <tr>
            <td style="width:400px" align="right" bgcolor="#f6f6f6">
                标题关键字：&nbsp;
                <asp:TextBox ID="txtTitle" Width="300" runat="server"></asp:TextBox>
            </td>
    ...
    <table width="100%" border="0" id="tbReport" cellpadding="0" cellspacing="1" bordercolorlight="#c8c8c8" bordercolordark="#FFFFFF" bgcolor="#CCCCCC" style="border-collapse:collapse;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid;border-bottom:1px #6f97b1 solid;border-top:1px #6f97b1 solid">
        <tr>
            <td style="border-top:0px;border-left:0px" width="31" align="center" bgcolor="#f6f6f6">
                <strong>选择</strong>
            </td>
            <td style="border-top:0px" width="150" height="30" align="center" bgcolor="#f6f6f6">
                <strong>标题</strong>
            </td>
            <td style="border-top:0px" width="120" align="center" bgcolor="#f6f6f6">
                <strong>附件</strong>
            </td>
            <td style="border-top:0px" width="80" align="center" bgcolor="#f6f6f6">
                <strong>创建人</strong>
            </td>
            <td style="border-top:0px" width="100" align="center" bgcolor="#f6f6f6">
                <strong>创建时间</strong>
            </td>
            <td style="border-top:0px;border-right:0px" width="80" align="center" bgcolor="#f6f6f6">
                <strong>操作</strong>
            </td>
        </tr>
            ...
            <ItemTemplate>
                <tr style="height:26px">
                    <td style="border-left:0px" bgcolor="#FFFFFF" align="center" height="26">
                        <input id="SelectCode" type="hidden" value='<%#Eval("F_ID")%>' runat="server" />
                        <input type="checkbox" name="cb1" tag="cb1" id="cb1" runat="server" />
                    </td>
                    <td bgcolor="#FFFFFF" align="left" height="26" title="<%#Eval("F_Title")%>">
                        &nbsp;<%#title(Eval("F_Title"),43)%>
                    </td>
                    <td bgcolor="#FFFFFF" align="left" height="26" title="<%#Eval("F_Name")%>">
                        &nbsp;<%#GetFile(Eval("F_URL").ToString()+Eval("F_Name").ToString())%>
                    </td>
                    <td bgcolor="#FFFFFF" align="center">
                        &nbsp;<%#ShowUserName(Eval("F_CreateUser").ToString())%>
                    </td>
                    <td bgcolor="#FFFFFF" align="center">
                        &nbsp;<%# Convert.ToDateTime(Eval("F_CreateDate")).ToString("yyyy-MM-dd HH:mm:ss")%>
                    </td>
                    <td style="border-right:0px" bgcolor="#FFFFFF" align="center" height="26">
                        <asp:LinkButton ID="LinkButton2" CommandArgument='<%#Eval("F_CreateUser")%>' CommandName='<%#Eval("F_ID")%>' runat="server" OnCommand="LinkButton2_Command" ToolTip="修改本条记录">
                            修改
                        </asp:LinkButton>
                        <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("F_CreateUser")%>' CommandName='<%#Eval("F_ID")%>' runat="server" OnCommand="LinkButton1_Command" ToolTip="删除本条记录" OnClientClick="return confirm('是否删除此条记录？')">
                            删除
                        </asp:LinkButton>
                    </td>
                </tr>
