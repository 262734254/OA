<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"CodeFile="N_SectionAdd.aspx.cs" Inherits="N_News_N_Performance_N_SectionAdd"%>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-top:1px #6f97b1 solid;border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <td width="10" bgcolor="#f6f6f6">&nbsp;</td>
    ...
    <div style="width:74px; height:27px; cursor:pointer;">科室考核</div></a></td>
    <%-- <td width="74" id="Td2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="N_Factory.aspx" class="a">
    <div style="width:73; height:27px;cursor:pointer;">分厂考核</div></a></td>--%>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
        ...
        <asp:TextBox runat="server" ID="tb_Title" TextMode="MultiLine" 
                Width="70%"  onkeyup="javascrip:checkWord(200,event,'ctl00_ContentPlaceHolder1_lbl1')" Height="35px">
                </asp:TextBox>
                &nbsp;
                <br />
