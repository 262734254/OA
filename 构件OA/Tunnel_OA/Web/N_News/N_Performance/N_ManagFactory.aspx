<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_ManagFactory.aspx.cs" Inherits="N_News_N_Performance_N_ManagFactory" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  ...
  <tr>
    ...
    <%-- <td width="74" id="Td2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="N_ManagementSection.aspx" class="a">
      <div style="width:73; height:27px; cursor:pointer;">管理科室</div>
    </a></td>--%>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="N_ManagFactory.aspx" class="a">
