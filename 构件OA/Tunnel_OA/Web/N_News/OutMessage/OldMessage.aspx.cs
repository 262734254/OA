...
public partial class N_News_OutMessage_NowMessage : System.Web.UI.Page
{
    ...
    {
        string strsql = "select * from Tunnel_Message where 1=1 and  DelDate is  null " + SearchWhere + "  order by MesDate Desc";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SearchWhere =
            ...
            "  MesContent like '%" + word + "%' ) and MesDate>='" + TextBox2.Text.Trim() + "' and MesDate<='"+TextBox3.Text.Trim()+"'";
        PageBind();
    }
