<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="N_XJBInfoAdd.aspx.cs" Inherits="N_News_N_EntryByTheDepartmentOf_N_XJBInfoAdd" %>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left: 1px #6f97b1 solid;
                    ...
                    <tr>
                        ...
                        <td align="left" bgcolor="#f6f6f6">
                            <asp:TextBox runat="server" ID="tb_Title" Width="70%" TextMode="MultiLine" onkeyup="javascrip:checkWord(200,event,'ctl00_ContentPlaceHolder1_lbl1')" Height="35px"></asp:TextBox>
                            <br />
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <label>
                                <asp:DropDownList ID="ddlXJBType" runat="server">
                                </asp:DropDownList>
                                <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="您不属于任何部门，不可以发布信息。" Visible="false"></asp:Label>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <label>
                                <asp:DropDownList ID="ddlXJBItem" runat="server">
                                    <asp:ListItem Text="生产日志" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="基地动态" Value="2"></asp:ListItem>
