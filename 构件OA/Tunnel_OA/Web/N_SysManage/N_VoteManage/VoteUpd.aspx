<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="VoteUpd.aspx.cs" Inherits="Vote_VoteUpd" %>
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#c1c1c1"
        ...
        <tr>
            ...
            <td height="17" align="left">
                ...
                <input id="Button1" type="button" value="添加" class="button" onclick="SelectUserWeb();" />
        ...
        <tr>
            <td colspan="2" align="center" style="height: 31px">
                <asp:Button ID="btnSave" runat="server" CssClass="button" Text="保存" OnClientClick="return yjhkk();"
