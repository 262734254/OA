<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_Add.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_SysManage_FormDesign_Form_add" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <tr>
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="Form_Add.aspx" class="a">
    <div style="width:73; height:27px; cursor:pointer;">添加表单</div></a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="Form_Manage.aspx" class="a">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
        ...
        <td bgcolor="#f6f6f6">
            <asp:TextBox ID="TextBox1" runat="server" Width="161px" onkeyup="javascrip:checkWord(200,event,'ctl00_ContentPlaceHolder1_lbl1')"></asp:TextBox>
