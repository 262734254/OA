<%@ Page Language="C#" AutoEventWireup="true" Title="流程分类添加" CodeFile="FlowClass_Add.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_SysManage_FlowClass_FlowClass_Add" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <tr>
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="FlowClass_Add.aspx" class="a">
    <div style="width:73; height:27px; cursor:pointer;">添加分类</div></a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="FlowClass_Manage.aspx" class="a">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
        ...
        <td bgcolor="#f6f6f6">
            <asp:TextBox ID="TextBox1" runat="server" Width="161px" onkeyup="javascrip:checkWord(100,event,'lbl1')"></asp:TextBox>
&nbsp;&nbsp;<span class="STYLE1">* </span><asp:Label ID="lbl1" runat="server" Font-Size="12px" Text="0/100"></asp:Label></td>
      </tr>
      <tr>
        <td height="48" align="center">备注：</td>
        <td>
            <asp:TextBox ID="TextBox2" runat="server" Height="41px" TextMode="MultiLine" 
                Width="343px" onkeyup="javascrip:checkWord(100,event,'Label1')"></asp:TextBox><br />
                <asp:Label ID="Label1" runat="server" Font-Size="12px" Text="0/500"></asp:Label>
                                </td>
      </tr>
