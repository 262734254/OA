<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Flow_StepAdd.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_SysManage_FlowDesign_Flow_StepAdd" %>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      ...
      <tr>
       ...
       <tr>
        <td width="80" height="30" align="center" bgcolor="#f6f6f6">审批意见：</td>
      ...
      <tr>
        <td width="80" height="30" align="center" bgcolor="#f6f6f6">经办人：</td>
      ...
      <tr>
        ...
        <td height="30" align="left" bgcolor="#e6f7ff" style="border-bottom:1px #6f97b1 solid">
            <asp:Button ID="Button1" runat="server" Text="添 加" OnClientClick="return onmm()" 
