<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Tunnel_DutyUpd.aspx.cs" Inherits="SystemManage_Tunnel_DutyUpd" %>
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="1" bordercolorlight="#c1c1c1"
        ...
        <tr>
            ...
            <td align="left" height="17">
                <asp:TextBox ID="txtName2" Height="101px" Width="213px" TextMode="MultiLine" runat="server"
                    CssClass="inputtext" onkeyup="javascrip:checkWord(1000,event,'lbl0')"></asp:TextBox>
