<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Document_Out.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_WorkFlow_VDocument_Document_Out" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  ...
  <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
  <tr>
    <td height="30" align="left" bgcolor="#FFFFFF">&nbsp;<a href="Document_View.aspx?File_Id=<%#Eval("f_id")%>&fid=<%=Request.Params["fid"] %>"><%#Eval("f_title")%></a></td>
