<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apply_Add.aspx.cs" MasterPageFile="~/MasterPage.master" Title="我的申请" Inherits="N_WorkFlow_MyApply_Apply_Add" %>
...
<script type="text/javascript">
    ...
    function issub(){
        ...
        if(document.getElementById("shr").style.display!="none"&&$("#ctl00_ContentPlaceHolder1_TextBox2").val()==""){
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border:1px #6f97b1 solid">
  <tr>
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="Apply_Add.aspx?Flow=<%=Request.Params["Flow"]%>" class="a">
      <div style="width:73; height:27px; cursor:pointer;">新建申请</div>
    </a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="Apply_Manage.aspx?Flow=<%=Request.Params["Flow"]%>" class="a">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      ...
      <%if (issheng)
        { %>
      <tr>
        <td height="30" align="center" bgcolor="#ffffff">审核人：</td>
      ...
      <tr id="shr" style="display:none">
        <td height="30" align="center" bgcolor="#f6f6f6">选择审批人：</td>
