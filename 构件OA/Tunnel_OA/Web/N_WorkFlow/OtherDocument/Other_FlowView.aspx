<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other_FlowView.aspx.cs" Inherits="Workflow_Tunnel_FlowView" %>
...
<body>
    ...
    <%=toptb%>
           ...
           <tr>
                ...
                <td align="left" style="height: 50%">&nbsp;<%#getNum(Eval("e_bid").ToString(),Eval("e_nextbid").ToString()) %></td>
