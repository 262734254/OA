<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other_Manage.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_WorkFlow_OtherDocument_Other_Manage" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
        <tr>
...
onpaste= "return   false "></asp:TextBox><img style="cursor:pointer" src="../../image/icon5.gif" onclick="td_calendar(this,'TextBox2')"/></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
        <tr>
          ...
          <td width="182" align="center" bgcolor="#f6f6f6"><strong>附件</strong></td>
        ...
        <tr>
          ...
          <td height="30" align="left" bgcolor="#FFFFFF">&nbsp;<a href="Other_View.aspx?lid=<%#Tunnel.Data.DESEncrypt.Encrypt(Eval("b_id").ToString()) %>" target="_blank"><%# geshiriqi(Eval("b_title"))%></a></td>
          ...
          <td align="center" bgcolor="#FFFFFF"><a href="Other_FlowView.aspx?lid=<%#Eval("b_id") %>" target="_blank">流程图</a> <%#GetMenu(Eval("b_id").ToString(), Eval("b_state").ToString(), Eval("b_user").ToString(), Eval("b_sort").ToString())%></td>
        </tr>
        </ItemTemplate>
        </asp:Repeater>
        <tr>
