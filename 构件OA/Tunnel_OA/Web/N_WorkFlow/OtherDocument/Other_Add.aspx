<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Other_Add.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_WorkFlow_OtherDocument_Other_Add" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border:1px #6f97b1 solid">
  <tr>
    ...
    <td width="74" id="icon1" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="Other_Add.aspx" class="a">
      <div style="width:73; height:27px; cursor:pointer;">新建申请</div>
    </a></td>
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicons"><a href="Other_Manage.aspx" class="a">
      <div style="width:73; height:27px;cursor:pointer;">管理申请</div>
    </a></td>
    <td bgcolor="#f6f6f6">&nbsp;</td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#f6f6f6">
            <asp:TextBox ID="TextBox1" runat="server" Width="259px" 
                onkeyup="javascrip:checkWord(200,event,'ctl00_ContentPlaceHolder1_lbl1')"></asp:TextBox>
