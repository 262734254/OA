<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Document_Edit.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="N_WorkFlow_ODocument_Document_Edit" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px #6f97b1 solid;border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      <tr>
        <td height="30" width="68" align="center" bgcolor="#f6f6f6">公文流程：</td>
        <td bgcolor="#f6f6f6"><asp:Repeater ID="Repeater1" runat="server">
      <ItemTemplate><%#Eval("s_name") %><%#getNext(Eval("s_num").ToString()) %></td>
    </tr>
      </ItemTemplate>
      </asp:Repeater>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-left:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
      ...
      <tr>
        ...
        <td width="796" align="center" id="contenttd">
    ...
    <tr  id="fileup" style="display:none">
      ...
      <tr>
        ...
        <td height="30" align="center" bgcolor="#e6f7ff" style="border-bottom:1px #6f97b1 solid">
            <asp:Button ID="Button1" runat="server" Text="重新发布" CssClass="button" 
