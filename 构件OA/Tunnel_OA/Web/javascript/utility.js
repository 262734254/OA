...
function SelectUser(modle_id,to_id,to_name)
{
    ShowDialog(to_id,to_name);
}

function ShowDialog(TO_ID,TO_NAME) {
           var url="/Systemmanage/basedata/Flow_UserSelect.aspx?to_id="+TO_ID+"&to_name="+TO_NAME;//+document.getElementById('DropDownList1').value;
           var iWidth=380; //窗口宽度
...
function td_calendar(obj,fieldname){
    var field=document.getElementById(fieldname);
    calendar.setHook(obj,field);
}