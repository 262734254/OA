<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_MessageReceive.aspx.cs"
    Inherits="grzm_ReceiveMessage" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-bottom:0px #6f97b1 solid;border-left:1px #6f97b1 solid;border-top:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <tr align="left">
    ...
    <td width="74" id="icon2" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="N_MessageReceive.aspx" class="a">
    ...
    <table id="tbReport"  width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" bordercolorlight="#c8c8c8" bordercolordark="#FFFFFF" 
        style="border-collapse:collapse;border-bottom: 1px #6f97b1 solid;border-left: 1px #6f97b1 solid; border-right: 1px #6f97b1 solid;border-top:1px #6f97b1 solid;">
        <tr height="20">
            ...
            <ItemTemplate>
                <tr height="26">
                    ...
                    <td bgcolor="#FFFFFF" align="left" height="26">
                        &nbsp;<a href="N_MessageView.aspx?Id=<%#Eval("m_id")%>&typeid=1" title="查看详细"><%#Eval("m_title")%></a>
                    </td>
                    ...
                    <td style="border-right:0px;border-top:0px" bgcolor="#FFFFFF" align="center" height="26">
