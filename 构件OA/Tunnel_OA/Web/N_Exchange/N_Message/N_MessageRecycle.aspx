<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="N_MessageRecycle.aspx.cs"
    Inherits="grzm_RecycleMessage" %>
...
<table width="100%" height="34" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-bottom:0px #6f97b1 solid;border-left:1px #6f97b1 solid;border-top:1px #6f97b1 solid;border-right:1px #6f97b1 solid">
  <tr align="left">
    ...
    <td width="74" id="icon4" valign="bottom" bgcolor="#f6f6f6" class="showicon"><a href="N_MessageRecycle.aspx" class="a">
      <div style="width:73; height:27px;cursor:pointer; text-indent:20px">回收站</div>
    </a></td>
    <td bgcolor="#f6f6f6">&nbsp;</td>
  </tr>
</table>
    <table id="tbReport"  width="100%" border="" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" bordercolorlight="#c8c8c8" bordercolordark="#FFFFFF" 
        ...
        <tr style="height: 20px">
            ...
            <td style="border-top:0px;border-right:0px" width="28" align="center" bgcolor="#f6f6f6" height="30">
                <strong>操作</strong>
            </td>
        </tr>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" align="left" height="26">
                        &nbsp;<a href="N_MessageView.aspx?Id=<%#Eval("m_id")%>&typeid=3" title="查看详细"><%#Eval("m_title")%></a>
                    </td>
                    ...
                    <td style="border-right:0px" bgcolor="#FFFFFF" align="center" height="26">
                        <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("m_id")%>' CommandName='<%#Eval("m_file")%>'
        ...
        <tr>
            <td style="border-top:0px;border-left:0px;border-right:0px;border-bottom:0px" colspan="8">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
            <td width="12%" align="center" bgcolor="#e6f7ff" style="border-bottom: 1px #6f97b1 solid">
            ...
            <td width="7%" bgcolor="#e6f7ff" style="border-bottom: 1px #6f97b1 solid">
            ...
            <td height="30" colspan="5" align="center" bgcolor="#e6f7ff" style="border-bottom: 1px #6f97b1 solid">
