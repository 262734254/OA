...
public partial class N_Index_gcgl : System.Web.UI.Page
{
    ...
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=26";
        ...
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=26 and del=0 and IsDel=0 order by setdate desc ";
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=26 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater1.DataSource = das2;
            Repeater1.DataBind();
    ...
    /// 生产设施的添置及报废动态信息
    /// </summary>
    private void Bindscsbdtzjbfdtxx()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=27";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=27 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=27 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater2.DataSource = das2;
            Repeater2.DataBind();
    ...
    ///  机械设备运营状况及日常管理 
    /// </summary>
    private void Bindjxsbyxzkjrcgl()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=28";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=28 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=28 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater3.DataSource = das2;
            Repeater3.DataBind();
    ...
    /// 外加工委托及外送修理情况日常汇总统计 
    /// </summary>
    private void Bindwjgwljwswxqkrchztj()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=29";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=29 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=29 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater4.DataSource = das2;
            Repeater4.DataBind();
    ...
    /// 分公司设备月报表
    /// </summary>
    private void Bindfgssbybb()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=30";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=30 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=30 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater5.DataSource = das2;
            Repeater5.DataBind();
    ...
    /// 资产名录 
    /// </summary>
    private void Bindzjml()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=31";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=31 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=31 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater6.DataSource = das2;
            Repeater6.DataBind();
    ...
    private void BindHT()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=156";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=156 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=156 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater14.DataSource = das2;
            Repeater14.DataBind();
    ...
    /// 申请表式 
    /// </summary>
    private void BindYSB()
    {
        string strsql = "select * from tunnel_newstype where IsDel=0 and parentid=157";
        DataSet das = Tunnel.Data.DbHelperSQL.Query(strsql);
        if (das.Tables[0].Rows.Count > 0)
        {
            ...
            string strsql2 = "select top " + gettop(8 - das.Tables[0].Rows.Count) + " * from tunnel_index where typeid=157 and del=0 and IsDel=0 order by setdate desc ";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
        ...
        {
            string strsql2 = "select top 8 * from tunnel_index where typeid=157 and del=0 and IsDel=0 order by setdate desc";
            DataSet das2 = Tunnel.Data.DbHelperSQL.Query(strsql2);
            Repeater16.DataSource = das2;
            Repeater16.DataBind();
    ...
    public void WriteSiteMap()
    {
        ...
        foreach (XmlNode xn in xnl)
        {
            ...
            xnChild.Attributes[0].Value = "N_Index/gcgl.aspx";
            xnChild.Attributes[1].Value = "工程管理部";
            xnChild.Attributes[2].Value = "工程管理部";
    ...
    private void LoadSource()
    {
        ...
        DataSet ds1 = m_IndexBLL.GetList("[typeId]=26 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        count = 0;
        DataSet ds2 = m_IndexBLL.GetList("[typeId]=27 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        count = 0;
        DataSet ds3 = m_IndexBLL.GetList("[typeId]=28 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        count = 0;
        DataSet ds4 = m_IndexBLL.GetList("[typeId]=29 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        count = 0;
        DataSet ds5 = m_IndexBLL.GetList("[typeId]=30 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        count = 0;
        DataSet ds6 = m_IndexBLL.GetList("[typeId]=31 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
