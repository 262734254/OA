...
{
    private Tunnel.BLL.Tunnel_InfoXJB tbll = new Tunnel.BLL.Tunnel_InfoXJB();
    ...
    public void WriteSiteMap(int num)
    {
        ...
        //        + "<span> &gt; </span>"
        //        + "<span><a title='" + model.BumName + "-" + tbBll.GetModel(bum_id).b_name + "' href='/" + model.Url + "?bum_id=" + bum_id + "&typeid=" + model.TypeID + "'>" + model.BumName + "-" + tbBll.GetModel(bum_id).b_name + "</a></span>"
        //        + "<span> &gt; </span>"
        //        + "<span><a title='" + temp + "' href='/N_Index/xjbmenu.aspx?typeid=" + model.TypeID + "&lanmuId=0&bum_id=" + bum_id + "&sectype=" + sectype + "'>" + temp + "</a></span>"
        //        + "<span> &gt; </span>"
        //        + "<span>详细信息</span>"
        //        + "</font>";
        //}
        ...
        div.InnerHtml = "<font class='titlfontson'><span><a title='首页' href='/Index.aspx'>首页</a></span>"
            ...
            + "<span> &gt; </span>"
            + "<span><a title='" + temp + "' href='/N_Index/xjb.aspx?bum_id=" + bum_id + "'>" + temp + "</a></span>"
            + "<span> &gt; </span>"
            + "<span>详细信息</span>"
            + "</font>";
    }
    ...
    public void AddDate(string content, int num)
    {
        ...
        relt = tbll.Add(model);
        if (relt > 0)
            Tunnel.Common.Message.Show(mess, "ViewXJB.aspx?Id=" + Id + "&TypeId=" + typeId + "&bum_id=" + bum_id + "&sectype=" + sectype);
    }
