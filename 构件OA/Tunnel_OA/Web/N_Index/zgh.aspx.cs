...
public partial class N_Index_zgh : System.Web.UI.Page
{
    ...
    public void WriteSiteMap()
    {
        ...
        foreach (XmlNode xn in xnl)
        {
            ...
            xnChild.Attributes[0].Value = "N_Index/zgh.aspx";
            xnChild.Attributes[1].Value = "总工室";
            xnChild.Attributes[2].Value = "总工室";
    ...
    private void LoadSource()
    {
        ...
        DataSet dsDT = m_IndexBLL.GetList("[typeId]=5 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        //    }
        //}
        Repeater1.DataSource = dsDT;
        Repeater1.DataBind();

        count = 0;
        DataSet dsWX = m_IndexBLL.GetList("[typeId]=6 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
        ...
        //    }
        //}
        Repeater2.DataSource = dsWX;
        Repeater2.DataBind();

        count = 0;
        DataSet dsBZ = m_IndexBLL.GetList("[typeId]=7 and del=0 and IsDel=0 ORDER BY [setDate] DESC");
