<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TelList.aspx.cs" Inherits="TelList" %>
    ...
    <form id="form1" runat="server" defaultbutton="Button1">
        <div>
            <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#c1c1c1"
                ...
                <tr>
                    <td align="left" class="tou" colspan="4" height="30">
                        &nbsp;通讯录--查询
                    </td>
                </tr>
                <tr>
                    <td align="center" class="tou" colspan="4" height="30">
                                                关键字：<asp:TextBox ID="TextBox1" runat="server" CssClass="inputtext"></asp:TextBox>&nbsp;<asp:Button
                            ID="Button1" runat="server" CssClass="butt" OnClick="Button1_Click" Text="搜索" /></td>
                </tr>
                <tr>
                    <td height="30" align="center" bgcolor="#e8e8e8" style="width: 9%">
                        <strong>用户名</strong></td>
                    <td height="30" align="center" bgcolor="#e8e8e8" style="width: 9%">
                        <strong>真实姓名</strong></td>
                    <td height="30" align="center" bgcolor="#e8e8e8" style="width: 9%">
                        <strong>手机/电话号码</strong></td>
                    <td height="30" align="center" bgcolor="#e8e8e8" style="width: 9%">
                        <strong>邮件地址</strong></td>   
                </tr>
                ...
                <ItemTemplate>
                                <tr onmouseover="this.style.backgroundColor='#F2F2F2'; this.style.color='#10a019';"
                                    onmouseout="this.style.backgroundColor='';this.style.color='';">                                    
                                        ...
                                        <a href="/N_SysManage/N_User/Tunnel_Userinfo.aspx?id=<%#Eval("m_id") %>" target=_blank>
                                            <%#Eval("m_login") %>
                                        </a>
                                    </td>
                                    <td height="26" align="center" style="width: 9%">
            ...
            <table>
                <tr>
                    <td align="right" class="style1">
                        <cc1:MTCPager ID="MTCPager1" runat='server' PagingMode='Digit' 
                            OnPageIndexChanged="MTCPager1_PageIndexChanged" Visible="False">
            ...
            <br />
            <a href="TelListExcel.aspx" target="_blank" style="color:Red">下载Excel文档格式通讯录</a></div>
    </form>
</body>
</html>
