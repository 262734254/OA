<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vote_ShowAllPic.aspx.cs"
    Inherits="_Default" %>
    ...
    <center>
        <table cellpadding="0" cellspacing="0" border="0" width="1024px" height="975px">
            ...
            <tr align="center" valign="top" height="600px" bgcolor="#ffffff">
                <td>
                    <asp:DataList ID="DataList1" runat="server" RepeatColumns="6" Width="935px" BorderWidth="0px"
                        OnItemCommand="DataList1_ItemCommand" DataKeyField="v_id" 
                                    ...
                                    <tr>
                                        <td align="center" height="20">
                                            <div style="text-align: center">
                                                &nbsp;<a href="CommentPhotos.aspx?v_id=<%#Eval("v_id") %>" target="_blank"><%# Eval("v_title") %></a></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="1">
                                            <table width="90%">
                                                <tr style="text-align: justify">
                                                    <td>
                                                        <font color="#3c3c3c">票数：<asp:Label ID="lblCount" runat="server" Text='<%# Eval("v_count") %>'></asp:Label></font>
                                                    </td>
                                                    <td>
                                                        <asp:Button runat="server" CommandName="Ed" CommandArgument='<%#Eval("v_id") %>'
                                                            ID="btn_Vote" Text="投票" />
                                                    </td>
                                                </tr>
                                            </table>
